...
Official **Sveriges Riksbank** (Sweden) daily exchange rates in Node.js / TypeScript — 29 currencies against the SEK, with history back to 2016. Zero dependencies, works in Node 18+, Bun, Deno, and edge runtimes (uses global `fetch`).
...
Powered by [AllRatesToday](https://allratestoday.com/central-bank-rates-api/riksbank/). Get a free API key at [allratestoday.com/register](https://allratestoday.com/register) — no credit card required.
