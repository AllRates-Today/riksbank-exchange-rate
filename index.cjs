'use strict';
// Sveriges Riksbank exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/riksbank';
...
/** Latest rate for one pair, e.g. getRate('EUR', 'SEK', { apiKey }). */
